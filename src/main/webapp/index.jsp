      ...
      <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
        ...
        <div class="w-full lg:w-2/3">
          ...
          >
            ...
            <div class="bg-gray-800 rounded px-4 py-4 flex flex-col justify-between leading-normal">
              <div>
                <div class="mt-3 md:mt-0 text-gray-500 font-bold text-2xl mb-2">
              ...
              <div class="flex mt-3">
                <img src="https://randomuser.me/api/portraits/men/86.jpg"
                     class="h-10 w-10 rounded-full mr-2 object-cover" />
                <div>
                  <p class="font-semibold text-gray-500 text-sm capitalize"> eduard franz </p>
                  <p class="text-gray-500 text-xs"> 14 Aug </p>
                </div>
              </div>
            </div>
          </a>
            ...
            <div class="bg-gray-800 rounded px-4 py-4 flex flex-col justify-between leading-normal">
              ...
              <div class="flex mt-3">
                <img src="https://randomuser.me/api/portraits/women/54.jpg"
                     class="h-10 w-10 rounded-full mr-2 object-cover" />
                <div>
                  <p class="font-semibold text-gray-500 text-sm capitalize"> Serenity Hughes </p>
                  <p class="text-gray-500 text-xs"> 14 Aug </p>
                </div>
              </div>
            </div>
        ...
        <div class="w-full lg:w-1/3 px-3">
          ...
          <div class="p-1 mt-4 mb-4">
            ...
            <button class="px-4 py-2 mt-4 bg-indigo-600 text-gray-200 rounded-b w-full capitalize tracking-wide">
              Subscribe
            </button>
          </div>
